import type { DerivedThinkingStep, ThinkingSemanticRole, ThinkingSourceBlock, ThinkingUIMode, ThinkingSummaryEvent } from "./types.ts";
...
export function parseThinkingMode(input: string): ThinkingUIMode | undefined {
